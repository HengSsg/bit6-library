...
//                .append("select no")
//                .append("from book")
//                .append("where name = "+Bookname).toString();
//        try {
...
//            if(rs.next()){
//                rent_bookDTO.setUser_no(user_num);
//                rent_bookDTO.setBook_no(rs.getInt("no"));
//            }
//
//            if(rent_bookDAO.Update_Rent_Book(rent_bookDTO)){//delete하는데 성공했으면 flag를 true로 바꿔서 main에 flag값 반환 값이용할거면 이용하기
//                flag = true;
//            }
//            con.close();
    ...
    /*public boolean IsPass_DeadLine(int user_num){//대출 시 데드라인이 넘었는지 확인함
        ...
        for(String get_CDT : CDT){
            ...
            try {
                ...
                CDT_date = new SimpleDateFormat("yy/MM/dd").parse(get_CDT);
